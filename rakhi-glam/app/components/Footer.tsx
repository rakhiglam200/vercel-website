      ...
      <div className="max-w-[1400px] mx-auto grid grid-cols-[1.5fr_1fr_1fr_1.5fr] gap-10 mb-10 max-lg:grid-cols-2 max-md:grid-cols-1">
        ...
        <div>
          ...
          <div className="flex gap-4 mt-4">
            ...
            <a href="https://wa.me/917736272601" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center w-10 h-10 rounded-full border border-white/20 text-white no-underline hover:border-[var(--color-gold)] hover:bg-[var(--color-gold)] hover:text-white transition-all" aria-label="WhatsApp">
        ...
        <div>
          ...
          <div className="flex items-start gap-3 mb-3">
            ...
            <span className="text-sm text-white/70">Calicut, Kerala, India</span>
          </div>
          <div className="flex items-center gap-3 mb-3">
            ...
            <span className="text-sm text-white/70">thauya9@gmail.com</span>
          </div>
          <div className="flex items-center gap-3 mb-3">
            ...
            <span className="text-sm text-white/70">+91 7736272601</span>
          </div>
        </div>
      </div>
